...
export const AppointmentFormScreen: React.FC = () => {
    ...
    const { getPet, addAppointment, addAppointments, updateAppointment, getAppointment, translations } = useAppContext();
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        if (!isEditing && type === AppointmentType.TherapeuticBath && durationValue) {
            ...
            if (bathFrequency === '1') {
                ...
                const selectedDayIndexes = Array.from(bathDays).map(day => dayNameToIndex[day]);
    ...
    const title = appointmentId 
        ...
        : `${translations.newAppointment} for ${pet.name}`;
