...
export const CalendarPlusIcon: React.FC<{ className?: string }> = ({ className }) => (
    <Icon className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 0 1 2.25-2.25h13.5A2.25 2.25 0 0 1 21 7.5v11.25m-18 0A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75m-18 0H18.5" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 12.75h-6m3-3v6" />
    </Icon>
);
...
export const FirstAidIcon: React.FC<{ className?: string }> = ({ className }) => (
    <Icon className={className}>
...
export const PillIcon: React.FC<{ className?: string }> = ({ className }) => (
    <Icon className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12.5l8-8a4.95 4.95 0 017 7l-8 8a4.95 4.95 0 01-7-7" />
...
export const SyringeIcon: React.FC<{ className?: string }> = ({ className }) => (
    <Icon className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M14.25 3.75l-6 6 1.5 1.5-6 6" />
        <path strokeLinecap="round" strokeLinejoin="round" d="m18 8.25-1.5-1.5" />
        <path strokeLinecap="round" strokeLinejoin="round" d="m14.25 3.75 1.5-1.5" />
        <path strokeLinecap="round" strokeLinejoin="round" d="m7.5 14.25 1.5 1.5" />
        <path strokeLinecap="round" strokeLinejoin="round" d="m3.75 18 1.5 1.5" />
    </Icon>
);
