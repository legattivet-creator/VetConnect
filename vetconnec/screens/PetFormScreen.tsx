        ...
        <Layout title={petId ? translations.editPet : translations.addPet}>
            <form onSubmit={handleSubmit} className="space-y-6">
                <div className="flex flex-col items-center space-y-4">
                    ...
                    <button type="button" onClick={() => photoInputRef.current?.click()} className="px-4 py-2 text-sm font-medium text-primary bg-primary/10 rounded-lg hover:bg-primary/20">{translations.choosePhoto}</button>
